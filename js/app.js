...
Player.prototype.handleInput = function(keyPress) {
    ...
    if (this.y > 383 && dead == 0) {
        this.y = 383;
    }
    if (this.y < 0 && dead == 0 && this.sprite == 'images/char-boy.png') {
        this.y = 63;
        deny.play();
    }      
    if (this.y < 0 && dead == 0 && (this.sprite =='images/char-boy-star.png' || this.sprite == 'images/char-boy-heart.png' || this.sprite == 'images/char-boy-star-heart.png')) {
        this.y = -10;  
    }
    if (this.x > 400 && dead == 0) {
        this.x = 400;
    }
    if (this.x < 2.5 && dead == 0) {
        this.x = 2.5;
    }
};
